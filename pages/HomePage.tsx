    ...
    <div className="space-y-16 pb-12">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 max-w-7xl mx-auto">
        {[
          ...
          <div key={idx} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-blue-100/50 transition-all text-center group">
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-end mb-8 px-2 border-b border-gray-100 pb-4">
          ...
          <Link to="/shop" className="text-blue-600 font-semibold hover:text-blue-800 flex items-center gap-1 transition-colors group">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-gray-900 text-white rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex justify-center gap-1 mb-6">
              {[1, 2, 3, 4, 5].map((_, i) => (
                <Star key={i} className="h-6 w-6 text-yellow-400 fill-current drop-shadow-md" />
              ))}
            </div>
            ...
            <div className="flex justify-center items-center gap-4">
              <img src="https://ui-avatars.com/api/?name=Alex+Doe&background=0A1AFF&color=fff" alt="Customer" className="h-14 w-14 rounded-full border-4 border-blue-500/50" />
