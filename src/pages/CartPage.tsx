  ...
  if (cart.length === 0) {
    return (
      <div className="text-center py-20 animate-in fade-in duration-500">
        <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6 transition-transform duration-300 hover:scale-110">
          <Trash2 className="h-10 w-10 text-gray-400" />
        </div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Your cart is empty</h2>
        <p className="text-gray-500 mb-8">Looks like you haven't added anything yet.</p>
        <Link to="/" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-bold transition-colors duration-300">
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-12">
        ...
        <div className="lg:col-span-7">
          <div className="space-y-4">
            {cart.map((item) => {
              ...
              return (
                <div key={itemId} className="flex gap-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden">
                  {maxStock === 0 && (
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start">
                        <Link to={`/product/${item.id}`} className="hover:text-blue-600 transition-colors duration-300">
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center border border-gray-200 rounded-lg w-fit">
                          <button 
                            ...
                            className="p-1.5 hover:bg-gray-50 text-gray-500 disabled:opacity-30 disabled:cursor-not-allowed transition-colors duration-300"
        ...
        <div className="lg:col-span-5 mt-8 lg:mt-0">
          <div className="bg-white rounded-2xl shadow-lg shadow-blue-100/50 border border-gray-100 p-6 sticky top-24 transition-all duration-300">
            ...
            {user ? (
              <button 
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-4 rounded-xl font-bold hover:from-blue-700 hover:to-blue-600 transition-all duration-300 shadow-lg shadow-blue-500/30 transform hover:-translate-y-0.5 active:scale-[0.98]"
              >
                Checkout Now
              </button>
            ) : (
              <div className="space-y-3">
                 ...
                 <button 
                    ...
                    className="w-full bg-gray-900 text-white py-3 rounded-xl font-bold hover:bg-gray-800 transition-colors duration-300 shadow-md"
                  >
                    Login to Checkout
                  </button>
              </div>
